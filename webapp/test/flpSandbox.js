		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#testcomodatacrudoperation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testcomodatacrudoperation-display": {
								"semanticObject": "testcomodatacrudoperation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.com.odatacrudoperation",
									"url": sap.ui.require.toUrl("test/com/odatacrudoperation")
								}
							}
						}
					}
